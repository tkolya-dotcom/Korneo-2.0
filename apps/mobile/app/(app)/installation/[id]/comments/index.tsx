...
const s = StyleSheet.create({
  ...
  comment: { backgroundColor: COLORS.card, borderRadius: 12, padding: 12, marginBottom: 10, borderLeftWidth: 3, borderLeftColor: COLORS.green },
  commentOwn: { borderLeftColor: COLORS.accent, backgroundColor: 'rgba(0, 217, 255, 0.1)' },
  commentHeader: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 6 },
  authorName: { color: COLORS.green, fontSize: 12, fontWeight: '600' },
  ...
  sendBtn: { backgroundColor: COLORS.green, width: 44, height: 44, borderRadius: 22, justifyContent: 'center', alignItems: 'center', marginLeft: 8 },
